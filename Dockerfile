...
RUN case "${TARGETARCH}" in \
    "amd64") \
        BINARY_URL="https://dl.nssurge.com/snell/snell-server-v5.0.0b2-linux-amd64.zip" ;; \
    "arm64") \
        BINARY_URL="https://dl.nssurge.com/snell/snell-server-v5.0.0b2-linux-aarch64.zip" ;; \
